...
export type GlobeConfig = Omit<COBEOptions, "onRender">;
...
export function Globe({
  ...
  useEffect(() => {
    ...
    const visibilityObserver = new IntersectionObserver(([entry]) => {
      // Defer the WebGL cost until the globe is first approached, then keep
      // the rendered scene alive so returning to the section is instant.
